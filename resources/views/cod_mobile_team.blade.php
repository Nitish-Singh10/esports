    ...
    <div class="sm:p-5 p-2">
        ...
        <div class="flex gap-4 mb-5">
            <a href="{{ url('/cod_mobile_team') }}"
                class="px-4 py-2 bg-indigo-600 text-white rounded-md shadow transition duration-200 mr-2">
                Team
            </a>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center py-6 text-gray-400">
                            No COD Mobile Team registrations found
                        </td>
                    </tr>
                @endforelse
            </tbody>
